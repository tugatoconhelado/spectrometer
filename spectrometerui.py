...
class Ui_spectrometer_widget(object):
    def setupUi(self, spectrometer_widget):
        ...
        self.counts_spectrum_plot = PlotWidget(self.horizontalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.counts_spectrum_plot.sizePolicy().hasHeightForWidth())
        self.counts_spectrum_plot.setSizePolicy(sizePolicy)
        self.counts_spectrum_plot.setMinimumSize(QtCore.QSize(100, 100))
        self.counts_spectrum_plot.setMaximumSize(QtCore.QSize(100000, 100000))
        self.counts_spectrum_plot.setObjectName("counts_spectrum_plot")
        self.plots_layout.addWidget(self.counts_spectrum_plot, 0, 1, 1, 1)
